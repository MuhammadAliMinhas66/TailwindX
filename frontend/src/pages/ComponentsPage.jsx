  ...
  return (
    ...
    >
      <Link to={`/component/${component._id}`}>
        <PixelCard 
          className="w-full aspect-[4/5] cursor-pointer hover:border-gray-700 hover:shadow-xl hover:shadow-blue-500/10"
      ...
      <div className="container mx-auto px-6 py-12">
        {components.length === 0 ? (
          <div className="text-center py-32">
            <p className="text-gray-500 text-2xl font-bold">No components yet</p>
            <p className="text-gray-600 mt-2">Check back soon for amazing components!</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {components.map((component, index) => (
              <ComponentCard key={component._id} component={component} index={index} />
            ))}
          </div>
        )}
      </div>
